...
type runArgs struct {
	...
	ReadOnly       bool   `json:"read_only" jsonschema:"true: solo inspecciona, nunca edita. false: edita y ejecuta comandos de verdad, pero SOLO dentro de un worktree git desechable (detached HEAD); el repo real nunca se toca. El resultado incluye el diff para revisar antes de aplicarlo a tu rama real."`
